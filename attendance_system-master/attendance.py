...
message = tk.Label(window, text="GEHU UNIVERSITY" ,bg="black"  ,fg="red"  ,width=20  ,height=2,font=('Times New Roman', 25, 'bold underline')) 
message.place(x=550, y=80)

message = tk.Label(window, text="ATTENDANCE MANAGEMENT PORTAL" ,bg="red"  ,fg="white"  ,width=40  ,height=1,font=('Times New Roman', 35, 'bold underline')) 
message.place(x=200, y=20)

lbl = tk.Label(window, text="Enter College ID",width=20  ,height=2  ,fg="black"  ,bg="Pink" ,font=('Times New Roman', 25, ' bold ') ) 
lbl.place(x=180-x_cord, y=200-y_cord)
...
lbl3 = tk.Label(window, text="Notification Screen",width=20  ,fg="black"  ,bg="pink"  ,height=2 ,font=('Times New Roman', 25, ' bold ')) 
...
message2 = tk.Label(window, text="" ,fg="red"   ,bg="white",activeforeground = "green",width=60  ,height=4  ,font=('times', 15, ' bold ')) 
message2.place(x=700, y=570-y_cord)

lbl4 = tk.Label(window, text="STEP 1",width=20  ,fg="black"  ,bg="pink"  ,height=2 ,font=('Times New Roman', 20, ' bold '))
lbl4.place(x=240-x_cord, y=375-y_cord)

lbl5 = tk.Label(window, text="STEP 2",width=20  ,fg="black"  ,bg="pink"  ,height=2 ,font=('Times New Roman', 20, ' bold ')) 
lbl5.place(x=645-x_cord, y=375-y_cord)

lbl6 = tk.Label(window, text="STEP 3",width=20  ,fg="black"  ,bg="pink"  ,height=2 ,font=('Times New Roman', 20, ' bold ')) 
        ...
        if MsgBox == 'no':
            ...
            while(True):
                ...
                for (x,y,w,h) in faces:
                    ...
                    val =   cv2.imwrite("TrainingImage\ "+name +"."+Id +'.'+ str(sampleNum) + ".jpg", gray[y:y+h,x:x+w])
                    if val == True:
                        print("saved image")
                    else:
                        print("not saved")
...
def TrackImages():
    ...
    if isIdentified == True:
        ...
        tk.messagebox.showinfo('Failed','Unable to recognize face!')
def quit_window():
...
takeImg = tk.Button(window, text="IMAGE CAPTURE BUTTON", command=TakeImages  ,fg="white"  ,bg="green"  ,width=25  ,height=2, activebackground = "pink" ,font=('Times New Roman', 15, ' bold '))
takeImg.place(x=245-x_cord, y=425-y_cord)
trainImg = tk.Button(window, text="MODEL TRAINING BUTTON", command=TrainImages  ,fg="white"  ,bg="green"  ,width=25  ,height=2, activebackground = "pink" ,font=('Times New Roman', 15, ' bold '))
trainImg.place(x=645-x_cord, y=425-y_cord)
trackImg = tk.Button(window, text="ATTENDANCE MARKING BUTTON", command=TrackImages  ,fg="white"  ,bg="green"  ,width=30  ,height=3, activebackground = "pink" ,font=('Times New Roman', 15, ' bold '))
